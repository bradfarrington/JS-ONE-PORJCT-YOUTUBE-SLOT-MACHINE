...
// 6. GIVE THE USER THEIR WINNINGS / TAKE BET AMOUNT
//7 7. PLAY AGAIN OR ASK TO DEPOSIT
...
const getNumberOfLines = () => {
  while (true) {
    const lines = prompt("How many lines to bet on (1-3): ");
    const numberOfLines = parseFloat(lines);

    if (isNaN(numberOfLines) || numberOfLines <= 0 || numberOfLines > 3) {
      console.log("Please enter a valid number of lines, try again!");
    } else {
